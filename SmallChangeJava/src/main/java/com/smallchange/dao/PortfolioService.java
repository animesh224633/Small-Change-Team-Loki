...
public class PortfolioService {
	...
	public List<Portfolio> getUserPortfolio(String clientId, List<Holdings> holdingsTable,
			List<Instrument> instrumentTable) {
		if(clientId==null) {
		...
		for(Holdings holdingTableIterator: holdingsTable) {
