...
import com.smallchange.dao.PortfolioService;
...
class PortfolioServiceTest {
	...
	private List<Holdings> holdingList;
	private List<Instrument> instrumentDAOList;
	private Instrument instrumentDAO;
	private Instrument instrumentDAO2;
	private Instrument instrumentDAO3;
	private Instrument instrumentDAO4;
	...
	void setup() {
		...
		Instrument instrumentDAO5 = new Instrument();
		...
		Holdings stockHolding1= new Holdings();
		...
		Holdings stockHolding2= new Holdings();
		...
		Holdings stockHolding3= new Holdings();
		...
		Holdings mutualFundHolding =new  Holdings();
	...
	@Test
	void addStock() {
		Holdings stockHolding5= new Holdings();
	...
	void testEmptyOrderTable() throws Exception{
		List<Holdings> emptyHolding=new ArrayList<>();
		IllegalArgumentException e=assertThrows(IllegalArgumentException.class, ()->{
