...
class SmallChangeWalletRechargeServiceTest {
	...
	List<ClientFinanceDetails> clientFinanceDetailsTable;
	...
	Client clientDAO2;
	Client clientDAO3;
	ClientFinanceDetails clientFinanceDetailsDAO1;
	ClientFinanceDetails clientFinanceDetailsDAO2;
	ClientFinanceDetails clientFinanceDetailsDAO3;
	...
	void setup() {
		...
		clientFinanceDetailsDAO1 = new ClientFinanceDetails();
		...
		clientFinanceDetailsDAO2 = new ClientFinanceDetails();
		...
		clientFinanceDetailsDAO3 = new ClientFinanceDetails();
