...
public class OrderServiceTest {
	public List<OrderDAO> orderDAOList;
	public List<InstrumentDAO> instrumentDAOList;
	public InstrumentDAO instrumentDAO;
	public List<HoldingsDAO> holdingsDAOList;
	public HoldingsDAO holdingDAO;
	public OrderService orderService;
	public OrderDAO orderDAO;
	public Order bo;
	public Order so;
	public String hid1,hid2,hid3;
public List<ClientDAO> clientDAOList;
private ClientDAO clientDAO;
	...
	public void setup() {
		...
		HoldingsDAO holdingDAO1;
		holdingDAO1=new HoldingsDAO();
